...
public class jsoncomparison : MonoBehaviour
{
    ...
    void Start()
    {
        KinectChildObjects = GetComponentsInChildren<Transform>();
        currentFrame = 0;
        string reader = File.ReadAllText(@"C:\Users\Kinect\Documents\Movements\matchingMovements.json");
    ...
    IEnumerator Play_JSON()
    {
        ...
        //transform.parent.position = new Vector3(localPosition.x, localPosition.y - 9, localPosition.z);
